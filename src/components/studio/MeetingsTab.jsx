  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => { setEditingMeeting(null); setShowForm(true); }} className="gap-2">
      ...
      <div className="space-y-3">
        {upcomingMeetings.length === 0 ? (
          <div className="p-8 text-center border border-dashed border-blue-900/40 rounded-xl">
            <Calendar className="w-8 h-8 text-blue-400/40 mx-auto mb-2" />
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <h3 className="font-semibold text-[#e8f4ff]">{meeting.title}</h3>
                  ...
                  {meeting.meeting_link && (
                    <a 
                      ...
                      className="inline-flex items-center gap-1 text-xs text-[#1e78ff] hover:text-[#00c8ff] mt-2 transition-colors"
                    >
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem onClick={() => deleteMutation.mutate(meeting.id)} className="text-red-400">
      ...
      <Dialog open={showForm} onOpenChange={(open) => {
        setShowForm(open);
        if (!open) { setEditingMeeting(null); resetForm(); }
      }}>
        <DialogContent className="sm:max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mt-4">
            ...
            <div className="flex justify-end gap-2 pt-2">
              ...
              <Button type="submit" size="sm">{editingMeeting ? "Update" : "Schedule"}</Button>
            </div>
          </form>
        </DialogContent>
      </Dialog>
